package com.simpotech.app.hlgg.scanner;
        ...
        mHideIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mPopupWindow == null) {
                    mPopupWindow = new PopupWindow(mHideLly, mBottomTv.getWidth(), (int)
                            (mBottomTv.getHeight() * 1.5), true);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.capture_scan_photo: // 图片识别
                ...
                // 打开手机中的相册
                Intent innerIntent = new Intent(Intent.ACTION_GET_CONTENT); // "android.intent
                // .action.GET_CONTENT"
