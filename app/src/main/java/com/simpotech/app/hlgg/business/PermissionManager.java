...
public class PermissionManager {
    ...
    static {
        ...
        permissionMap.put("1", new String[]{"入库", "入库查询"});   //入库权限
        permissionMap.put("2", new String[]{"出库", "出库查询"});   //出库权限
        permissionMap.put("3", new String[]{"质检", "质检查询"});   //质检权限
        permissionMap.put("4", new String[]{"入库", "出库", "入库查询", "出库查询"}); //入库,出库权限
        permissionMap.put("5", new String[]{"入库", "质检", "质检查询", "入库查询"}); //入库,质检权限
        permissionMap.put("6", new String[]{"出库", "质检", "质检查询", "出库查询"}); //出库,质检权限
        permissionMap.put("7", new String[]{"入库", "出库", "质检", "质检查询", "入库查询",
