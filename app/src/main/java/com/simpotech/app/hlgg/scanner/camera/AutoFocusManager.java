...
package com.simpotech.app.hlgg.scanner.camera;
...
import com.simpotech.app.hlgg.scanner.common.MyRunnable;
import com.simpotech.app.hlgg.scanner.config.Config;
...
final class AutoFocusManager implements Camera.AutoFocusCallback {
	...
	public synchronized void onAutoFocus(boolean success, Camera theCamera) {
		if (active) {
			...
			MyRunnable.execAsync(outstandingTask);
		}
	}
